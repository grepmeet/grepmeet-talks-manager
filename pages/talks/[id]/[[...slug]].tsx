        ...
        <div>
            <Container as="section" py={{base: 5, md: 10}} maxW="5xl">
                <Stack spacing={5}>
                    ...
                    <Stack spacing="10" direction={{base: "column", md: "row"}} align="center" justify="space-between">
                        {talk.tags && (
                            <Wrap>
                                {talk.tags.map(tag => (
                                    <Tag
                        ...
                        <Author
                            ...
                            href={`#/speaker/${talk.speaker.id}/${speakingurl(talk.speaker.fullName)}`}
                        />
                    </Stack>
                </Stack>

                <Grid mt="20" templateColumns={{base: "1fr", md: "5fr 3fr"}} gap="10" alignItems="flex-start">
                    <Box as="article" order={{base: 2, md: 1}} py="5">
                        <Heading as="h2" size="lg" mb="5">Description</Heading>
                        <Text as="div" mb={{base: 10, md: 20}}>
                            <p>Lorem ipsum dolor <strong>sit amet</strong>, consectetur adipisicing elit. <a href="#">Ab
                                accusantium eveniet excepturi</a> incidunt, ipsa ipsam ipsum itaque labore numquam
                                provident qui quo saepe velit! A distinctio minus nulla praesentium vero?</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab accusantium eveniet
                                excepturi incidunt, ipsa ipsam ipsum itaque labore numquam provident qui quo saepe
                                velit! A distinctio minus nulla praesentium vero?</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab accusantium eveniet
                                excepturi incidunt, ipsa ipsam ipsum itaque labore numquam provident qui quo saepe
                                velit! A distinctio minus nulla praesentium vero?</p>
                        </Text>

                        <Heading as="h2" size="lg" mb="5">Speaker</Heading>
                        <Author
                            photoURL={talk.speaker.photoURL}
                            fullName={talk.speaker.fullName}
                            subtitle={talk.speaker.subtitle}
                            size="xl"
                            mb={5}
                            href={`#/speakers/${talk.speaker.id}/${speakingurl(talk.speaker.fullName)}`}
                        />
                        <Text as="div" mb="5">
                            <p>Lorem ipsum dolor <strong>sit amet</strong>, consectetur adipisicing elit. <a href="#">Ab
                                accusantium eveniet excepturi</a> incidunt, ipsa ipsam ipsum itaque labore numquam
                    ...
                    <Box as="aside" order={{base: 1, md: 2}} bg="gray.50" p="5" marginY={{base: '-5', md: 0}}>
                        <Heading as="h2" size="lg" mb="5">Stats</Heading>

                        <Stack spacing="5">
                            <Progress colorScheme='secondary' borderRadius="base" value={talk.nbVotes / 20 * 100}/>
